...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test-eof.exe:test/test-eof:$LINENO: libtool wrapper (GNU libtool) 2.4", f);
  fputs (".6.42-b88ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-eof.exe:test/test-eof:$LINENO: newargv[$lt_dump_args_N]: $lt_ar", f);
  fputs ("g\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-eof.exe:test/test-eof:$LINENO: newargv[0]: $progdir/$progra", f);
  fputs ("m\" 1>&2\n", f);
