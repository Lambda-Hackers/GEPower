...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test-weof.exe:test/test-weof:$LINENO: libtool wrapper (GNU libtool) 2", f);
  fputs (".4.6.42-b88ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-weof.exe:test/test-weof:$LINENO: newargv[$lt_dump_args_N]: $lt_", f);
  fputs ("arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-weof.exe:test/test-weof:$LINENO: newargv[0]: $progdir/$prog", f);
  fputs ("ram\" 1>&2\n", f);
