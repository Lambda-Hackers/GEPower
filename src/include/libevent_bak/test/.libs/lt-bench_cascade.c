...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"bench_cascade.exe:test/bench_cascade:$LINENO: libtool wrapper (GNU li", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bench_cascade.exe:test/bench_cascade:$LINENO: newargv[$lt_dump_args_", f);
  fputs ("N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bench_cascade.exe:test/bench_cascade:$LINENO: newargv[0]: $progd", f);
