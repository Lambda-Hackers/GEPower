...
/* test/.libs/lt-test-closed.c - temporary wrapper executable for .libs/test-closed.exe
...
const char * TARGET_PROGRAM_NAME = "test-closed.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# test/test-closed - temporary wrapper script for .libs/test-closed.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The test/test-closed program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"test-closed.exe:test/test-closed:$LINENO: libtool wrapper (GNU libtoo", f);
  fputs ("l) 2.4.6.42-b88ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-closed.exe:test/test-closed:$LINENO: newargv[$lt_dump_args_N]: ", f);
  fputs ("$lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-closed.exe:test/test-closed:$LINENO: newargv[0]: $progdir/$", f);
  fputs ("program\" 1>&2\n", f);
