...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test-ratelim.exe:test/test-ratelim:$LINENO: libtool wrapper (GNU libt", f);
  fputs ("ool) 2.4.6.42-b88ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-ratelim.exe:test/test-ratelim:$LINENO: newargv[$lt_dump_args_N]", f);
  fputs (": $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-ratelim.exe:test/test-ratelim:$LINENO: newargv[0]: $progdir", f);
  fputs ("/$program\" 1>&2\n", f);
