...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"bench_http.exe:test/bench_http:$LINENO: libtool wrapper (GNU libtool)", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"bench_http.exe:test/bench_http:$LINENO: newargv[$lt_dump_args_N]: $l", f);
  fputs ("t_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"bench_http.exe:test/bench_http:$LINENO: newargv[0]: $progdir/$pr", f);
  fputs ("ogram\" 1>&2\n", f);
