...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' libevent_core.la libevent_extra.la /d/project/GEPower/src/i", f);
  fputs ("nclude/libevent/libevent_core.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"regress.exe:test/regress:$LINENO: libtool wrapper (GNU libtool) 2.4.6", f);
  fputs (".42-b88ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"regress.exe:test/regress:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"regress.exe:test/regress:$LINENO: newargv[0]: $progdir/$program\"", f);
  fputs (" 1>&2\n", f);
