...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test-changelist.exe:test/test-changelist:$LINENO: libtool wrapper (GN", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-changelist.exe:test/test-changelist:$LINENO: newargv[$lt_dump_a", f);
  fputs ("rgs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-changelist.exe:test/test-changelist:$LINENO: newargv[0]: $p", f);
