...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"test-dumpevents.exe:test/test-dumpevents:$LINENO: libtool wrapper (GN", f);
  fputs ("U libtool) 2.4.6.42-b88ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test-dumpevents.exe:test/test-dumpevents:$LINENO: newargv[$lt_dump_a", f);
  fputs ("rgs_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test-dumpevents.exe:test/test-dumpevents:$LINENO: newargv[0]: $p", f);
