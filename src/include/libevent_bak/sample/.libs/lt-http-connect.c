...
/* sample/.libs/lt-http-connect.c - temporary wrapper executable for .libs/http-connect.exe
   Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty

   The sample/http-connect program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "d:\\project\\GEPower\\src\\include\\libevent\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\project\\GEPower\\src\\include\\libevent\\.libs;d:\\project\\GEPower\\lib\\lib;d:\\project\\GEPower\\lib\\bin;";
const char * TARGET_PROGRAM_NAME = "http-connect.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sample/http-connect - temporary wrapper script for .libs/http-connect.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6.42-b88ce-dirty\n", f);
  fputs ("#\n", f);
  fputs ("# The sample/http-connect program cannot be directly executed until all the lib", f);
  fputs ("tool\n", f);
  ...
  fputs ("    echo \"http-connect.exe:sample/http-connect:$LINENO: libtool wrapper (GNU li", f);
  fputs ("btool) 2.4.6.42-b88ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"http-connect.exe:sample/http-connect:$LINENO: newargv[$lt_dump_args_", f);
  fputs ("N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"http-connect.exe:sample/http-connect:$LINENO: newargv[0]: $progd", f);
  ...
  fputs ("\n", f);
  fputs ("  program='http-connect.exe'\n", f);
  ...
  fputs ("    PATH=/d/project/GEPower/src/include/libevent/.libs:/d/project/GEPower/lib/l", f);
  fputs ("ib:/d/project/GEPower/lib/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/project/GEPower/src/include/libevent/.libs:$PATH\"\n", f);
  fputs ("\n", f);
