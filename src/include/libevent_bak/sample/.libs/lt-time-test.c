...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"time-test.exe:sample/time-test:$LINENO: libtool wrapper (GNU libtool)", f);
  fputs (" 2.4.6.42-b88ce-dirty\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"time-test.exe:sample/time-test:$LINENO: newargv[$lt_dump_args_N]: $l", f);
  fputs ("t_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"time-test.exe:sample/time-test:$LINENO: newargv[0]: $progdir/$pr", f);
  fputs ("ogram\" 1>&2\n", f);
