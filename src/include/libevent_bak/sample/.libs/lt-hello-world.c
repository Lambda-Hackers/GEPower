...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"hello-world.exe:sample/hello-world:$LINENO: libtool wrapper (GNU libt", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"hello-world.exe:sample/hello-world:$LINENO: newargv[$lt_dump_args_N]", f);
  fputs (": $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"hello-world.exe:sample/hello-world:$LINENO: newargv[0]: $progdir", f);
  fputs ("/$program\" 1>&2\n", f);
